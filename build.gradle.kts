...
val version = "b4"
val mixinGroup = "me.oringo.oringoclient.mixins"
val modid = "oringo"
...
dependencies {
    ...
    shadowImpl(libs.bundles.asm)

    compileOnly(libs.lombok)
    annotationProcessor(libs.lombok)

    compileOnly(libs.mixin)
    shadowImpl(libs.kxSer)
}
...
tasks.withType(Jar::class) {
    archiveBaseName.set("OringoReborn")
    manifest.attributes.run {
        ...
        this["FMLCorePlugin"] = "me.oringodevmode.Transformer"
        this["FMLCorePluginContainsFMLMod"] = "true"
