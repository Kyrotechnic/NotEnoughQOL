...
public class FreeCam extends Module
{
    ...
    public void onEnable() {
        if (FreeCam.mc.theWorld != null) {
            ...
            FreeCam.mc.theWorld.addEntityToWorld(-2137, (Entity) (Object) this.playerEntity);
        }
    }
    ...
    public void onRenderWorld(final RenderWorldLastEvent event) {
        if (this.isToggled() && this.playerEntity != null && this.tracer.isEnabled()) {
            RenderUtils.tracerLine((Entity) (Object) this.playerEntity, event.partialTicks, 1.0f, OringoClient.clickGui.getColor());
        }
    }
