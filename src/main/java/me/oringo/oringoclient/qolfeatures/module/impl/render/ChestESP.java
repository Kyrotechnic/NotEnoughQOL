...
public class ChestESP extends Module
{
    ...
    public void onRender(final RenderWorldLastEvent event) {
        ...
        for (final TileEntity tileEntityChest : ChestESP.mc.theWorld.loadedTileEntityList.stream().filter(tileEntity -> tileEntity instanceof TileEntityChest).collect(Collectors.toList())) {
