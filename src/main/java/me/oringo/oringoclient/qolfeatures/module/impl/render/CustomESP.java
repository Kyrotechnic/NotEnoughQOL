...
public class CustomESP extends Module
{
    ...
    public void onRender(final RenderWorldLastEvent event) {
        ...
        for (final Entity entity : CustomESP.mc.theWorld.getEntities(EntityArmorStand.class, entity -> entity.getDistanceSqToEntity((Entity)CustomESP.mc.thePlayer) < 10000.0)) {
