...
public abstract class PlayerSPMixin extends AbstractClientPlayerMixin
{
    ...
    public void superMoveEntityWithHeading(final float strafe, final float forward, final boolean onGround, final float friction2Multi) {
        if (this.isServerWorld()) {
            if (!this.isInWater() || (((Entity) (Object) this) instanceof EntityPlayer && this.capabilities.isFlying)) {
                if (!this.isInLava() || (((Entity) (Object) this) instanceof EntityPlayer && this.capabilities.isFlying)) {
                    float f4 = 0.91f;
                    if (onGround) {
                    ...
                    if (this.isOnLadder()) {
                        ...
                        final boolean flag = this.isSneaking() && ((Entity) (Object) this) instanceof EntityPlayer;
                ...
                float f8 = 0.8f;
                float f9 = 0.02f;
                float f10 = (float)EnchantmentHelper.getDepthStriderModifier((Entity) (Object) this);
                if (f10 > 3.0f) {
                    f10 = 3.0f;
                }
                if (!this.onGround) {
    ...
    public boolean isUsingItem(final EntityPlayerSP instance) {
        return !OringoClient.noSlow.isToggled() && (instance.isUsingItem() || OringoClient.autoBlock.isBlocking());
    }
    ...
    public void onLivingUpdate(final CallbackInfo ci) {
        ...
        if (OringoClient.speed.isToggled() && !Speed.isDisabled() && this.getFoodStats().getFoodLevel() > 6.0f && !this.isSprinting()) {
            this.setSprinting(true);
        }
        ...
        if (OringoClient.noSlow.isToggled() && (this.isUsingItem() || OringoClient.autoBlock.isBlocking())) {
            ...
            if (action == EnumAction.BLOCK) {
                ...
                movementInput.moveForward *= (float)OringoClient.noSlow.swordSlowdown.getValue();
                ...
                movementInput3.moveForward *= (float)OringoClient.noSlow.bowSlowdown.getValue();
                ...
                movementInput5.moveForward *= (float)OringoClient.noSlow.eatingSlowdown.getValue();
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        if (this.noClip) {
            ...
            final double d5 = y;
            double d6 = z;
            final boolean flag = ((this.onGround && this.isSneaking()) || (PlayerUtils.isOnGround(1.0) && OringoClient.scaffold.isToggled() && Scaffold.safeWalk.isEnabled())) && ((Entity) (Object) this) instanceof EntityPlayer;
            if (flag) {
                final double d7 = 0.05;
                while (x != 0.0 && this.worldObj.getCollidingBoundingBoxes((Entity) (Object) this, this.getEntityBoundingBox().offset(x, -1.0, 0.0)).isEmpty()) {
                    if (x < d7 && x >= -d7) {
                        x = 0.0;
                    }
                    else if (x > 0.0) {
                ...
                while (z != 0.0 && this.worldObj.getCollidingBoundingBoxes((Entity) (Object) this, this.getEntityBoundingBox().offset(0.0, -1.0, z)).isEmpty()) {
                    if (z < d7 && z >= -d7) {
                        z = 0.0;
                    }
                    else if (z > 0.0) {
                ...
                while (x != 0.0 && z != 0.0 && this.worldObj.getCollidingBoundingBoxes((Entity) (Object) this, this.getEntityBoundingBox().offset(x, -1.0, z)).isEmpty()) {
                    if (x < d7 && x >= -d7) {
                        x = 0.0;
                    }
                    else if (x > 0.0) {
            ...
            final List<AxisAlignedBB> list1 = (List<AxisAlignedBB>)this.worldObj.getCollidingBoundingBoxes((Entity) (Object) this, this.getEntityBoundingBox().addCoord(x, y, z));
            ...
            if (this.stepHeight > 0.0f && flag2 && (d4 != x || d6 != z)) {
                ...
                final List<AxisAlignedBB> list2 = (List<AxisAlignedBB>)this.worldObj.getCollidingBoundingBoxes((Entity) (Object) this, this.getEntityBoundingBox().addCoord(d4, y, d6));
    ...
    public void attackTargetEntityWithCurrentItem(final Entity targetEntity) {
        if (ForgeHooks.onPlayerAttackTarget((EntityPlayer)(Object)this, targetEntity) && targetEntity.canAttackWithItem() && !targetEntity.hitByEntity((Entity) (Object) this)) {
            ...
            if (f > 0.0f || f2 > 0.0f) {
                ...
                f += f2;
                boolean flag2 = false;
                final int j = EnchantmentHelper.getFireAspectModifier((EntityLivingBase)(Object)this);
                ...
                final boolean flag3 = targetEntity.attackEntityFrom(DamageSource.causePlayerDamage((EntityPlayer)(Object)this), f);
                if (flag3) {
                    if (i > 0) {
